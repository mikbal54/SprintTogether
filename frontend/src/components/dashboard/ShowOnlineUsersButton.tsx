...
interface ShowOnlineUsersButtonProps {
  onlineUsers?: User[] // Keep for backward compatibility
}

function ShowOnlineUsersButton({ onlineUsers: propOnlineUsers }: ShowOnlineUsersButtonProps) {
...
export default React.memo(ShowOnlineUsersButton)
